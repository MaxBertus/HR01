...
p_marker_com = [0.09255 -0.0025 0.04305]';
%R_marker_com = eye(3);

%% Data import

% load('rosbag2_2022_02_21-10_42_35.mat')
...
if traj == 0
    switch num % SQUARE 
        case 1
            load('rosbag2_2022_02_21-10_52_18.mat')
        case 2
            load('rosbag2_2022_02_21-10_56_55.mat')
        case 3
             load('rosbag2_2022_02_21-11_04_16.mat')
    end
else
     switch num % STEPS 
        case 1
            load('rosbag2_2022_02_21-11_10_14.mat')
        case 2
            load('rosbag2_2022_02_21-11_28_42.mat')
        case 3
            load('rosbag2_2022_02_21-11_31_48.mat')
        case 4
            load('rosbag2_2022_02_21-11_35_30.mat')
        case 5
            load('rosbag2_2022_02_21-11_42_18.mat')
     end
end
...
p_marker_vicon_x = viconhr01hr01x_trans'./1e+03;
p_marker_vicon_y = viconhr01hr01y_trans'./1e+03;
p_marker_vicon_z = viconhr01hr01z_trans'./1e+03;
...
% ATTITUDE
% Unit of measure adjustment
q_marker_vicon_w = viconhr01hr01w'./1e+03;
q_marker_vicon_x = viconhr01hr01x_rot'./1e+03;
q_marker_vicon_y = viconhr01hr01y_rot'./1e+03;
q_marker_vicon_z = viconhr01hr01z_rot'./1e+03;
...
%     save('sequences_HR01.mat', 'sequenceSquare')
% else
...
%     save('sequences_HR01.mat', 'sequenceSteps','-append')
% end
